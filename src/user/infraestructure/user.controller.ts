import { Controller, Get, Post, Body, Patch, Param, Delete, ParseUUIDPipe, NotFoundException, UseInterceptors } from '@nestjs/common';
...
import { TimeoutInterceptor } from 'src/common/infraestructure/interceptors/timeout.interceptor';
